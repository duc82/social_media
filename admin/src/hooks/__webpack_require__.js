...
/* harmony import */ var _utils_slideUp__WEBPACK_IMPORTED_MODULE_0__ =
  __webpack_require__(/*! ./utils/slideUp */ "./src/utils/slideUp.js");
/* harmony import */ var _utils_slideDown__WEBPACK_IMPORTED_MODULE_1__ =
  __webpack_require__(/*! ./utils/slideDown */ "./src/utils/slideDown.js");
/* harmony import */ var _utils_getParents__WEBPACK_IMPORTED_MODULE_2__ =
  __webpack_require__(/*! ./utils/getParents */ "./src/utils/getParents.js");
  ...
  _createClass(HSSideNav, [
    {
      ...
      value: function init() {
        ...
        var $mainContainer = document.querySelector(
          this.settings.mainContainer
        );
        this.topLevelElements = collapseElementList.filter(function (
          collapseEl
        ) {
          return (
            Object(_utils_getParents__WEBPACK_IMPORTED_MODULE_2__["default"])(
              collapseEl,
              ".nav-collapse"
            ).length === 1
          );
          ...
          this.collapseList.forEach(function (collapse) {
            Array.from([
              ...
              $el.addEventListener("mouseenter", function (e) {
                if (
                  !$mainContainer.classList.contains(
                    _this.settings.minClass.slice(1)
                  ) &&
                  !_this.isCompact
                )
                  return;
              ...
              $el.addEventListener("mouseleave", function (e) {
                ...
                if (
                  _this.topLevelElements.includes(
          ...
          collapse._element.addEventListener("show.bs.collapse", function (e) {
            var trigeredEl = e.target,
              parentEl = e.target.hasAttribute("hs-parent-area")
                ? document.querySelector(
                    e.target.getAttribute("hs-parent-area")
                  )
                : null;
            ...
            if (
              ($mainContainer.classList.contains(
                ...
                _this.isCompact) &&
              _this.topLevelElements.includes(trigeredEl)
            ) {
              e.preventDefault();
            ...
            _this.collapseList.forEach(function (collapse) {
              ...
              if (
                collapseEl && triggeredArea
                  ? collapseArea === triggeredArea
                  : false
              ) {
                collapse.hide();
        ...
        this.$el.addEventListener("transitionend", function () {
          document
            .querySelector(_this.settings.mainContainer)
            .classList.remove(_this.settings.transitionOnClassName);
        }); // Done initializing
    ...
    },
    {
      ...
      value: function setState() {
        ...
        if (mini) {
          this.settings.$showedMenu =
            document.querySelector(".nav-collapse.show");
    ...
    },
    {
      ...
      value: function toggleSubMenu($invoker) {
        ...
        var collapseOthers =
          ...
          allExcludeTarget = _toConsumableArray(
            $invoker.parentNode.querySelectorAll(
              ":scope > ".concat(this.settings.hasSubMenuClass)
            )
        ...
        if (
          (collapseOthers && onAction) ||
          (collapseOthers && topLevel && mini)
        ) {
          allExcludeTarget
            .reduce(function (acc, $item) {
              return (acc = [].concat(
                ...
                _toConsumableArray(
                  $item.querySelectorAll(_this2.settings.subMenuClass)
                )
              ));
            }, [])
            .forEach(function ($item) {
              ...
              $item.parentNode.classList.remove(
                _this2.settings.subMenuInvokerActiveClass.slice(1)
              );
            });
          ...
          allExcludeTarget
            ...
            .forEach(function ($item) {
              Object(_utils_slideUp__WEBPACK_IMPORTED_MODULE_0__["default"])(
                $item,
                _this2.settings.subMenuAnimationSpeed
        ...
        if (onAction || (topLevel && mini)) {
          ...
          if (window.getComputedStyle($menu).display === "none") {
            Object(_utils_slideDown__WEBPACK_IMPORTED_MODULE_1__["default"])(
              $menu,
    ...
    },
    {
      ...
      value: function toggleSidebar() {
        ...
        $mainContainer.classList.contains(this.sidebarToggleClass.slice(1))
          ...
          : $mainContainer.classList.add(this.sidebarToggleClass.slice(1)); // Toggle aside
        ...
        if (
          ...
          (this.showResolutionChecking() &&
            $mainContainer.classList.contains(
              this.settings.closedClass.slice(1)
            ))
        ) {
        ...
        if (
          ...
          document
            ...
            .forEach(function ($item) {
              ...
              document
                .querySelectorAll(".nav-collapse.show")
                .forEach(function ($menu) {
